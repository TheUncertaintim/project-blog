...
<CodeSnippet lang="js">{`12 ÷ 4`}</CodeSnippet>
...
<CodeSnippet lang="js">{`11 ÷ 4`}</CodeSnippet>
...
<DivisionGroupsDemo numOfItems={11} initialNumOfGroups={4} />
...
<CodeSnippet lang="js">{`12 % 4; // 0`}</CodeSnippet>
...
<CodeSnippet lang="js">{`11 % 4; // 3`}</CodeSnippet>
